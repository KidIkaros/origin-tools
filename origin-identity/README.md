...
sibling `origin-crypto-sdk` `0.7.1-rc.4` candidate pinned by the workspace and CI.
The SDK is experimental until independently audited.

```bash
# 1. Use the sibling origin-crypto-sdk 0.7.1-rc.4 checkout required by origin-tools.
