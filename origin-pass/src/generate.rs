...
pub const WORDLIST: &[&str] = &[
    // ── group 1 ──────────────────────────────────────────────────────
    "after", "apple", "apricot", "arrow", "autumn", "badge", "banner", "barrel", "beach",
    "berry", "bicycle", "blade", "blaze", "bloom", "bolt", "bonus", "bottle", "brave",
    "bread", "breeze", "brick", "bridge", "bright", "bronze", "bucket", "butter", "cabin",
    "cactus", "camera", "candle", "canyon", "carbon",
    // ── group 2 ──────────────────────────────────────────────────────
    "carpet", "carrot", "castle", "cedar", "celery", "chain", "chalk", "cherry", "chest",
    "circle", "circus", "clover", "coast", "cobra", "coffee", "coin", "comet", "compass",
    "copper", "coral", "cotton", "couch", "crane", "crater", "crayon", "creek", "crimson",
    "crown", "crystal", "daisy", "dawn", "desert",
    // ── group 3 ──────────────────────────────────────────────────────
    "diamond", "dolphin", "donkey", "dragon", "drift", "drum", "dusk", "eagle", "earth",
    "echo", "eclipse", "ember", "engine", "falcon", "feather", "fern", "field", "finch",
    "flame", "flash", "flock", "flour", "fog", "forest", "fossil", "fountain", "fox",
    "frost", "galaxy", "garden", "garnet", "geyser",
    // ── group 4 ──────────────────────────────────────────────────────
    "ginger", "glacier", "glade", "glass", "globe", "glove", "glow", "gold", "goose",
    "grape", "grass", "gravel", "green", "grove", "guitar", "gulf", "gust", "hammer",
    "harbor", "hawk", "hazel", "heart", "hedge", "hill", "honey", "horizon", "hornet",
    "horse", "hurricane", "icicle", "igloo", "iron",
    // ── group 5 ──────────────────────────────────────────────────────
    "island", "ivy", "jacket", "jade", "jungle", "juniper", "kettle", "kindle", "koi",
    "lagoon", "lake", "lantern", "laurel", "leaf", "lemon", "lily", "linen", "lion",
    "lizard", "lobster", "lodge", "lotus", "lumber", "maple", "marble", "meadow",
    "melon", "mercury", "mesa", "meteor", "mint", "mist",
    // ── group 6 ──────────────────────────────────────────────────────
    "moon", "moss", "moth", "mountain", "mouse", "mushroom", "nectar", "nest", "nickel",
    "night", "north", "nugget", "oak", "oasis", "ocean", "olive", "onion", "opal",
    "orange", "orbit", "orchid", "otter", "owl", "oyster", "palm", "panther", "paper",
    "parrot", "pass", "pearl", "pebble", "pepper",
    // ── group 7 ──────────────────────────────────────────────────────
    "petal", "pine", "pinto", "planet", "plaza", "plum", "pond", "poppy", "prairie",
    "prism", "puppy", "quartz", "quill", "quilt", "rabbit", "raven", "reef", "ridge",
    "river", "robin", "rock", "rose", "ruby", "rust", "saddle", "salmon", "sand",
    "sapphire", "scarf", "school", "scrub", "sea",
    // ── group 8 ──────────────────────────────────────────────────────
    "seal", "shark", "shelf", "shell", "shore", "silver", "skate", "slate", "slope",
    "smoke", "snail", "snake", "snow", "soap", "sparrow", "spear", "spider", "spore",
    "spring", "spruce", "squid", "star", "stone", "storm", "stream", "summit", "sunset",
    "swan", "swift", "sword", "tiger", "toast",
];    /// Build the effective password charset from the exclusion flags.
    /// Returns an error if every class is excluded.
    pub fn build_charset(exclude_symbols: bool, exclude_digits: bool, exclude_upper: bool) -> Result<Vec<u8>, String> {
    ...
    if out.is_empty() {
        return Err(
            "all character classes excluded — nothing to generate from (lowercase is always on)".to_string(),
        );
    }
    Ok(out)
}
