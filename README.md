...
[origin-crypto-sdk](../origin-crypto-sdk) `0.7.1-rc.2` candidate. Modeled on Office 365 / Google
...
>
> **SDK candidate:** `origin-crypto-sdk 0.7.1-rc.2`, pinned by exact version and
